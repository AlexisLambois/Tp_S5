...
public interface ImageGrise {
    ...
    ImageGrise ajouter(ImageGrise img) throws ImagesIncompatiblesException;
    /** Retourne une image en retranchant point par point les niveaux de gris de l'image 
     * courante et de l'image en paramètre (les deux images doivent être de même taille) */
    ImageGrise soustraire(ImageGrise img) throws ImagesIncompatiblesException;
    ...
    ImageGrise XOR(ImageGrise img) throws ImagesIncompatiblesException;
