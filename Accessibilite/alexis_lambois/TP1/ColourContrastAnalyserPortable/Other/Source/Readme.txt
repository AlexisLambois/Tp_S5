DEVELOPER: Replace the three occurrences of ColourContrastAnalyserPortable in this file
...
user in an INI file next to ColourContrastAnalyserPortable.exe called ColourContrastAnalyserPortable.ini.
...
copy AppNamePortable.ini from this directory to ColourContrastAnalyserPortable.ini next to
ColourContrastAnalyserPortable.exe. The options in the INI file are as follows:
